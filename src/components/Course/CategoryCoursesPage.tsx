  ...
  return (
    <div className="bg-gray-50 min-h-screen px-4 py-12 mt-8 md:mt-20">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-xl md:text-3xl font-bold mb-6 text-gray-800">{category} Courses</h2>
        <div className="
          grid gap-6
          grid-cols-1
          sm:grid-cols-2
        ...
        ">
          {coursesToShow.map(course => (
            <div
              key={course._id}
              className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 group flex flex-col">
